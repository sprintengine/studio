...
export function pendingPairRequestNote(request, nowMs) {
...
export function OutboundPairRequestCard({ request, now, variant = 'card', }) {
    ...
    return (<div className={frame} data-outbound-request={request.requestId}>
      ...
      {request.reverseOffered ? (<p className="mb-2 text-micro text-[color:var(--text-subtle)]">
