...
// MC-1670 D6: the sprint wizard no longer declares sibling projects up front.
// A run creates with only its primary project and expands on demand mid-run, so
// the "Also changes these projects" picker is gone from every wizard surface.
assert.ok(
  !all.includes('Also changes these projects') && !withoutWorkflow.includes('Also changes these projects'),
  'no sibling-projects picker remains in the wizard controls',
)
