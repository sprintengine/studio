    ...
    <div className="flex flex-col gap-5">
      ...
      {draft.trim() ? (
        <button
          type="button"
          onClick={() => commit('')}
          className="w-fit rounded text-[12px] text-[color:var(--text-subtle)] underline-offset-2 hover:text-[color:var(--text-default)] hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent-primary)]"
        >
