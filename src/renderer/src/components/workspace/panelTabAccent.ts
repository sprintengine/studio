...
const PANEL_TAB_ACCENT: Record<PanelTabAccentKind, { moduleId: string; enabledClass: string }> = {
  watchtower: { moduleId: 'switchboard', enabledClass: 'text-[color:var(--tool-watchtower)]' },
  switchboard: { moduleId: 'switchboard', enabledClass: 'text-[color:var(--tool-switchboard)]' },
