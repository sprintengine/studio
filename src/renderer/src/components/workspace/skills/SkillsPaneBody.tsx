...
function Row({
  ...
  const expandButton = (
    <button
      ...
      className="interactive flex min-w-0 flex-1 items-baseline gap-2 px-3 py-1.5 text-left focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[color:var(--accent-primary-soft)]"
    >
