    ...
    <div className="flex h-full min-h-0 flex-col gap-3">
      <header className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 flex-col leading-tight">
          ...
          />
          <span className="inline-flex items-center gap-1.5 truncate text-meta text-[color:var(--text-muted)]">
            {state.kind === 'ready' ? (
        ...
        {state.kind === 'ready' ? (
          <button
            ...
            className="
              inline-flex h-6 shrink-0 items-center rounded-sm px-1.5 text-micro text-[color:var(--text-muted)]
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto rounded-md border border-[color:var(--border-default)] bg-[color:var(--bg-surface)] px-5 py-5">
        {state.kind === 'ready' ? (
          <div className="text-heading leading-7 text-[color:var(--text-strong)]">
          ...
          <div className="flex h-full flex-col items-center justify-center gap-2 text-center">
            <span className="text-meta font-semibold text-[color:var(--tone-warn)]">
              {unavailableTitle}
            </span>
