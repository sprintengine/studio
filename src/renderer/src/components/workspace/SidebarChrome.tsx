  ...
  return (
    <Tooltip content="Collapse sidebar" placement="bottom">
      <button
        ...
        aria-pressed={true}
        className="app-no-drag interactive inline-flex h-7 w-7 items-center justify-center bg-transparent text-[color:var(--text-strong)] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[color:var(--accent-primary-soft)]"
      >
