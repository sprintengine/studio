...
const ROW_ROSTER_TRIGGER_BASE =
  'interactive inline-flex max-w-[9rem] shrink-0 items-center gap-1 rounded-sm px-1.5 text-[10.5px] leading-[17px] transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-[color:var(--border-focus)]'
