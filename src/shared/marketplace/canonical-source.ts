...
// carries the app's releases and the hosted card and sources feeds. The registry client's
...
// releases repo is already public, already fetched hourly for the hosted feeds,
