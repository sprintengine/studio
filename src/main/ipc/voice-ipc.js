import { transcribeAudio, TranscriptionError, } from '../../shared/voiceTranscription';
...
export function registerVoiceIpc(ipcMain) {
    ipcMain.handle('voice:transcribe', async (_event, wav, settings) => {
