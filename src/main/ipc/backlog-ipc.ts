...
export function registerBacklogIpc(ipcMain: IpcMain): void {
  ...
  ipcMain.handle(
    ...
    (_event, input: BacklogAddOrUpdateLinkInput): Promise<BacklogMutationResult> => {
  ...
  ipcMain.handle(
    ...
    (_event, input: BacklogModuleMetadataInput): Promise<BacklogMutationResult> => {
  ...
  ipcMain.handle(
    ...
    (_event, input: BacklogMoveSourceInput): Promise<BacklogMutationResult> => {
  ...
  ipcMain.handle(
    ...
    (_event, input: BacklogRemoveRecordInput): Promise<BacklogMutationResult> => {
  ...
  ipcMain.handle(
    ...
    (_event, input: BacklogEpicColorInput): Promise<BacklogMutationResult> => {
  ...
  ipcMain.handle(
    ...
    (_event, input: BacklogDependenciesInput): Promise<BacklogMutationResult> => {
