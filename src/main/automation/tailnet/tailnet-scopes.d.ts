 ...
 */
export declare function isLocalOnlyGatewayTool(toolName: string): boolean;
/**
 ...
 */
export declare function requiredScopeForTool(toolName: string, isMutation: boolean): TailnetScope;
