...
// engine posts these verbatim through the provider's postComment; they are the
// "what your team sees" text the T11 preview mirrors. Plain, human, honest — no
// agent internals, no run-store jargon, and NEVER a secret. Kept side-effect-free
// so the exact wording is unit-testable on its own.
...
const SIGNATURE = '— posted automatically by Multicode'
