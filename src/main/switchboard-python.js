...
const inFlightPythonChildren = new Set();
...
function parseJsonPayload(output) {
    ...
    if (!trimmed)
        throw new Error('Switchboard core returned no JSON output.');
...
export async function runSwitchboardPythonJsonCommand(args) {
...
export async function shutdownSwitchboardPythonCommands() {
