...
import { addSwitchboardComment, cancelSwitchboardTask, claimSwitchboardTask, configureSwitchboardExecutionStopper, configureSwitchboardRuntimeInventoryProvider, configureSwitchboardSessionSpawner, configureSwitchboardSessionStopper, createSwitchboardTask, getSwitchboardExecutionLogs, getSwitchboardExecutionStatus, getSwitchboardRunnerState, getWatchtowerRun, initializeSwitchboard, listWatchtowerRuns, moveSwitchboardTask, pauseSwitchboardRunner, promoteSwitchboardInboxTask, publishSwitchboardTask, readAllSwitchboardTasks, recordSwitchboardSessionExit, recoverSwitchboardLock, requeueSwitchboardTask, resumeSwitchboardRunner, startSwitchboardRunner, startWatchtowerReview, startWatchtowerTriage, stopSwitchboardExecution, stopSwitchboardRunnerAndExecutions, tickSwitchboardRunner, updateSwitchboardTask, } from '../switchboard-files';
...
export const switchboardModule = {
    manifest: {
        id: 'switchboard',
    ...
    registerMain(host) {
        ...
        configureSwitchboardRuntimeInventoryProvider(() => terminalRuntime
        ...
        terminalRuntime.registerAgentSessionExitListener((event) => {
            if (event.system !== 'switchboard' && event.system !== 'watchtower')
                return;
