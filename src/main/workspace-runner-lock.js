...
function lockDirForWorkspace(workspaceRoot) {
...
async function isStaleLock(lockDir, ownerPath) {
...
export async function acquireWorkspaceRunnerLock(workspaceRoot) {
...
export async function releaseWorkspaceRunnerLock(workspaceRoot) {
    const normalizedRoot = normalizeWorkspaceRoot(workspaceRoot);
...
export async function releaseAllWorkspaceRunnerLocks() {
