...
export function registerCoreIpc(ipcMain, services, diagnosticsEnabled, options = {}) {
    ...
    if (options.includeDevModules ?? true)
    ...
    registerTrackerIpc(ipcMain, undefined, undefined, undefined, createTrackerWriteBackNoticeDeps(services.trackerWriteBack));
