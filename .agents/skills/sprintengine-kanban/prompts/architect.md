...
- Write a clear `sprintengine/plan.md` covering: goal, approach, risks, and open questions
...
- Register the final team plan as an `architect_plan` artifact at `sprintengine/<team-slug>/plan.md`.
...
- Owns a review/scheduling document path such as `sprintengine/<team-slug>/reviews/final-review-schedule-1.md`.
