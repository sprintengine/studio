...
MCP_TOOL_CONTRACTS: dict[str, McpToolContract] = {
    ...
    for contract in [
        ...
        _command("sprintengine.task.advance", cmd_task_advance),
        _command("sprintengine.task.request_changes", cmd_task_request_changes),
        _command("sprintengine.task.approve_rework", cmd_task_approve_rework),
        _command("sprintengine.task.reassign_review", cmd_task_reassign_review),
        ...
        _command("sprintengine.plan.set_proof", cmd_plan_set_proof),
        _command("sprintengine.plan.upsert_seam", cmd_plan_upsert_seam),
        _command("sprintengine.plan.remove_seam", cmd_plan_remove_seam),
        ...
        _command("sprintengine.proof.begin", cmd_proof_begin),
        _command("sprintengine.proof.record", cmd_proof_record),
        _command("sprintengine.proof.request_human", cmd_proof_request_human),
