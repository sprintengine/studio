...
MCP_V1_CONTRACT_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "sprintengine.plan.add_task": object_schema(["statePath", "title", "role"], {"actor": {"type": "string"}, "taskId": {"type": "string"}, "title": {"type": "string"}, "description": {"type": "string"}, "role": {"type": "string"}, "repo": REPO_PROPERTY, "dependsOn": {"type": "array"}, "path": {"type": "array"}, "acceptance": {"type": "array"}, "note": {"type": "array"}, "taskNote": {"type": "array"}, "kind": {"type": "string", "enum": ["work", "integration_proof"]}, "producesImplementation": {"type": "boolean"}, "producesSeamIds": {"type": "array", "items": {"type": "string"}}, "consumesSeamIds": {"type": "array", "items": {"type": "string"}}, "needsTriage": {"type": "boolean"}, "phases": PHASES_PROPERTY, "productFacing": {"type": "boolean"}, "notProductFacing": {"type": "boolean"}, **ARCHITECT_DIFFICULTY_PROPERTIES}),
    "sprintengine.plan.update_task": object_schema(["statePath", "taskId"], {"actor": {"type": "string"}, "taskId": {"type": "string"}, "title": {"type": "string"}, "description": {"type": "string"}, "role": {"type": "string"}, "repo": REPO_PROPERTY, "path": {"type": "array"}, "acceptance": {"type": "array"}, "note": {"type": "array"}, "taskNote": {"type": "array"}, "clearTaskNotes": {"type": "boolean"}, "kind": {"type": "string", "enum": ["work", "integration_proof"]}, "producesImplementation": {"type": "boolean"}, "producesSeamIds": {"type": "array", "items": {"type": "string"}}, "clearProducesSeamIds": {"type": "boolean"}, "consumesSeamIds": {"type": "array", "items": {"type": "string"}}, "clearConsumesSeamIds": {"type": "boolean"}, "needsTriage": {"type": "boolean"}, "clearNeedsTriage": {"type": "boolean"}, "phases": PHASES_PROPERTY, "productFacing": {"type": "boolean"}, "notProductFacing": {"type": "boolean"}, **ARCHITECT_DIFFICULTY_PROPERTIES}),
    ...
    "sprintengine.plan.set_proof": object_schema(["statePath", "required"], {"actor": {"type": "string"}, "required": {"type": "boolean"}, "taskId": TASK_ID_PROPERTY, "mode": {"type": "string", "enum": ["app_drive", "engine_smoke", "human_smoke"]}, "rationale": {"type": "string"}}),
    "sprintengine.plan.upsert_seam": object_schema(["statePath", "seam"], {"actor": {"type": "string"}, "seam": {"type": "object"}}),
    "sprintengine.plan.remove_seam": object_schema(["statePath", "seamId"], {"actor": {"type": "string"}, "seamId": {"type": "string"}}),
    ...
    "sprintengine.proof.begin": object_schema(["statePath", "taskId", "id"], {"taskId": TASK_ID_PROPERTY, "id": AGENT_ID_PROPERTY}),
    "sprintengine.proof.record": object_schema(["statePath", "taskId", "id", "artifactPath"], {"taskId": TASK_ID_PROPERTY, "id": AGENT_ID_PROPERTY, "artifactPath": {"type": "string"}, "artifactId": ARTIFACT_ID_PROPERTY, "title": {"type": "string"}}),
    "sprintengine.proof.request_human": object_schema(["statePath", "taskId", "id", "artifactPath", "blocker"], {"taskId": TASK_ID_PROPERTY, "id": AGENT_ID_PROPERTY, "artifactPath": {"type": "string"}, "artifactId": ARTIFACT_ID_PROPERTY, "title": {"type": "string"}, "blocker": {"type": "string"}}),
