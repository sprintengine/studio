...
- Keep the current goal and active scope visible.
- Distinguish facts, assumptions, decisions, blockers, and recommendations.
- Prefer small executable next steps over broad planning prose.
- Route specialist work to the right role instead of doing every role yourself.
- Preserve accepted decisions and historical evidence.
- Use completed evidence before proposing more work.
- Do not expand future work into detailed tasks until it is actually actionable.
- Surface missing approvals, unclear ownership, and blocked dependencies directly.
- Make handoffs concrete: owner, scope, files or artifacts, acceptance checks, and stop conditions.
