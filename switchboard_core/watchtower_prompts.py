    ...
    return "\n".join(
        [
            ...
            *task_lines,
            ...
            "",
            "```bash",
            f"scripts/switchboard comment --workspace {json.dumps(workspace_text)} <task-id> --kind triage --author Architect --author-type agent --author-id watchtower-architect --confidence-pct <0-100> --body '<comment-body>'",
            "```",
